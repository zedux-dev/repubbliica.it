<template>
    <div class="meteo-box" :style="!temperatura ? 'opacity: 0;' : ''">
...
<style>
    ...
    .meteo-box > .search > input:focus {
        border-color: var(--primary-color);
        color: var(--primary-color);
    }

    .meteo-box > .search > input:focus ~ .search-icon {
        fill: var(--primary-color);
    }

    .meteo-box > .search > .search-icon {
        position: absolute;
        right: 0;
        top: calc(50% - 7px);
        height: 20px;
    ...
    .meteo-box > .search > .search-icon > svg {
        width: 20px;
        height: 20px;
    }
    ...
    .meteo-box > .icon.parzialmente-nuvoloso { background-position: 0 -38px; }
    .meteo-box > .icon.pioggia-lieve { background-position: 0 -76px; }
    .meteo-box > .icon.temporale { background-position: 0 -114px; }
    .meteo-box > .icon.nuvoloso { background-position: 0 -152px; }
    .meteo-box > .icon.rovesci { background-position: 0 -190px; }
    .meteo-box > .icon.neve { background-position: 0 -304px; }
    .meteo-box > .icon.nebbia { background-position: 0 -380px; }
    .meteo-box > .icon.sereno { background-position: 0 -608px; }
    .meteo-box > .icon.night.sereno { background-position: 0 -456px; }
    .meteo-box > .icon.night.parzialmente-nuvoloso { background-position: 0 -494px; }
    .meteo-box > .icon.night.pioggia-lieve { background-position: 0 -532px; }
</style>